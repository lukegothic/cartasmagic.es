...
const { FIRMA, LIMITES_PAQUETE, PLAZO_ETIQUETA, APROVECHAR_CAJA, ETIQUETA, PEDIR_DIRECCION } = require('./textos-correo');
...
// Cierra el bloque logistico: detras del peso y las medidas, delante de la invitacion a
// llenar la caja. `conOferta` lo pasa ManaBox, donde ademas de la etiqueta caduca la cifra.
const plazoEtiqueta = (conOferta = false) =>
  parrafo(conOferta ? PLAZO_ETIQUETA.conOferta : PLAZO_ETIQUETA.etiqueta);

const plazoEtiquetaTexto = (conOferta = false) =>
  conOferta ? PLAZO_ETIQUETA.conOferta : PLAZO_ETIQUETA.etiqueta;
