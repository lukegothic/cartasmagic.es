...
//
//   1. Pedirsela a ellos. Tienen programa de socios y api; un correo a
...
const PENDIENTE =
  ...
  'fuentes/starcitygames.js: hay que pedirsela, no cogerla de su javascript.';

const starcitygames = async () => [];

module.exports = { PENDIENTE, starcitygames };
